...
<body>
    ...
    <div id="map-container-google-1" class="z-depth-1-half map-container" style="height: 500px; z-index: 0;">
        <iframe src="https://maps.google.com/maps?q=kathfordcollege&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0"
            style="margin-top: 4.9rem;" allowfullscreen></iframe>
    </div>
...
<div class="container contact mb-5 pb-5">
    ...
    try{
      ...
      $db = new mysqli ("localhost","root","","roomfinder");
